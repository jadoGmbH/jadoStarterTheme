...
function jado_settings_fields(): void
{
    ...
    $options = [
        'imgQuality' => 'Image Quality JPG Settings',
        'gutenberg_full_width' => 'Gutenberg Full Width',
        'disableGutenbergCustomStyle' => 'Disable Gutenberg Custom Style',
        'disableEmoji' => 'Disable Emoji',
        'AdminPostThumbnail' => 'Admin Post Thumbnail',
        'removeXMLRPC' => 'Remove XML-RPC',
        'deactivateXMLSitemap' => 'Deactivate XML Sitemap',
        'disableEditorFullscreenDefault' => 'Disable Editor Fullscreen Default',
        'enableSVGUploads' => 'Enable SVG Uploads',
        'setAltAttrImage' => 'Set Alt Attribute for Images',
        'disableAdminBarFrontend' => 'Disable Admin Bar in Frontend',
        'disableEmbedsFrontend' => 'Disable Embeds in Frontend',
        'disableComments' => 'Disable Comments',
        'encodeEmails' => 'Encode Emails',
        'heartbeat' => 'Heartbeat Control',
        'scriptW3C' => 'Script W3C Compliance',
        'pageExcerpts' => 'Enable Page Excerpts',
        'activateJquery' => 'Activate jQuery',
        'editor_role_menu' => 'Editor Role Menu'
    ];
